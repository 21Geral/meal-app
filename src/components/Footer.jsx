export default function Footer() {
  ...
  return (
    <footer className="bg-[#8B2E2E] py-6 px-4 text-white">
      <div className="container mx-auto max-w-screen-xl flex flex-col space-y-6">
        <div className="flex flex-col md:flex-row w-full items-center justify-between">
          <div className="w-full md:w-1/3 text-center md:text-left order-3 md:order-1 py-2">
            <p className="text-lx">© {new Date().getFullYear()} Gourmet Recipe.</p>
          </div>
          ...
          <div className="w-full md:w-1/3 text-center order-1 md:order-2">
            ...
            <div className="flex justify-center space-x-4">
              {socialLinks.map(({ href, svg }, i) => (
                <a key={i} href={href} target="_blank" rel="noopener noreferrer" className="hover:scale-110 active:scale-110 transition-transform">
                  {svg}
                </a>
              ))}
            </div>
          ...
          <div className="w-full md:w-1/3 text-center md:text-right order-2 md:order-3">
            ...
            <div className="text-sm space-y-1">
              <p>Telephone: 02229 456-789</p>
              <p>WhatsApp: +54 9 11 1555-6677</p>
              <p>Email: contact@gourmetrecipe.com</p>
            </div>
          </div>
        </div>
      </div>
