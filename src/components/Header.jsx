    ...
    md:hidden"
        >
          ...
          <div className="flex flex-col mt-12 text-2xl">
            <div className="px-4 py-2 cursor-pointer active:scale-105">Food</div>
            <div className="px-4 py-2 cursor-pointer active:scale-105">Entertainment</div>
            <div className="px-4 py-2 cursor-pointer active:scale-105">Blog</div>
            <div className="px-4 py-2 pb-10 cursor-pointer active:scale-105">Location</div>
          </div>
        </section>
        ...
        <div className="hidden md:flex md:flex-1 items-center justify-between pl-10">
          ...
          <ul className="flex gap-10 text-white font-semibold text-2xl pr-10">
            ...
            <li className="cursor-pointer hover:text-gray-200">Entertainment</li>
