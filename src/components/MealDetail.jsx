    ...
    <>
      <main className="max-w-[2000px] mx-auto px-12 md:px-32 py-4 xl:px-52">
        <div className="relative rounded-xl overflow-hidden shadow-lg">
          <img src={meal.strMealThumb} alt={meal.strMeal} className="w-full h-52 md:h-80 lg:h-[550px] object-cover object-center" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mt-6">
          ...
          <aside className="bg-[#F2ECE1] rounded-xl shadow-md p-6 text-2xl order-3 lg:order-2 lg:row-span-2">
            <h2 className="font-bold text-gray-800 mb-4">Information</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-gray-800 mt-6 mb-2">Related Recipes</h2>
